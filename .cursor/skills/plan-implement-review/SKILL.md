...
- Prompt the review subagent to:
  ...
  3. Produce its report using that skill's output template (e.g. Critical / Suggestions / Positive).
  4. Save the report to `reviews/` (e.g. `reviews/<short-feature-name>-review.md`) and also return it.
