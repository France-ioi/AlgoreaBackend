...
Note: it's better to use the **"Installing from source"**,
otherwise you might encounter an issue where the content of the structures,
like inputs and responses, aren't parsed and don't show.
