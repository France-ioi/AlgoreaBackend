Feature: Create a temporary user
  ...
  Examples:
    ...
    |                               | [Header not defined]            | fr                        | [Header not defined]                                                                                                                                                                                                                                                                              | "access_token":"ny93zqri9a2adn4v1ut6izd76xb3pccw", |
    | ?default_language=en          | [Header not defined]            | en                        | [Header not defined]                                                                                                                                                                                                                                                                              | "access_token":"ny93zqri9a2adn4v1ut6izd76xb3pccw", |
    | ?use_cookie=0                 | [Header not defined]            | fr                        | [Header not defined]                                                                                                                                                                                                                                                                              | "access_token":"ny93zqri9a2adn4v1ut6izd76xb3pccw", |
    | ?use_cookie=1&cookie_secure=1 | [Header not defined]            | fr                        | access_token=3!ny93zqri9a2adn4v1ut6izd76xb3pccw!127.0.0.1!/; Path=/; Domain=127.0.0.1; Expires=Fri, 17 Jul 2020 00:02:28 GMT; Max-Age=7200; HttpOnly; Secure; SameSite=Strict                                                                                                                     |                                                    |
    | ?use_cookie=1                 | access_token=2!abcd!127.0.0.1!/ | fr                        | access_token=; Path=/; Domain=127.0.0.1; Expires=Thu, 16 Jul 2020 21:45:48 GMT; Max-Age=0; HttpOnly; Secure; SameSite=None\naccess_token=1!ny93zqri9a2adn4v1ut6izd76xb3pccw!127.0.0.1!/; Path=/; Domain=127.0.0.1; Expires=Fri, 17 Jul 2020 00:02:28 GMT; Max-Age=7200; HttpOnly; SameSite=Strict |                                                    |
