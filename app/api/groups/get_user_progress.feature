Feature: Display the current progress of users on a subset of items (groupUserProgress)
  Background:
    ...
    And the database has the following table 'groups_attempts':
      | group_id | item_id | order | started_at          | score | best_answer_at      | hints_cached | submissions_attempts | validated | validated_at        | last_activity_at    |
      | 14       | 211     | 0     | 2017-05-29 06:38:38 | 0     | 2017-05-29 06:38:38 | 100          | 100                  | 0         | 2017-05-30 06:38:38 | 2018-05-30 06:38:38 | # last_activity_at for 51, 211 comes from this line (the last activity is made by a team)
      ...
      | 67       | 212     | 1     | 2019-01-01 00:00:00 | 10    | 2017-05-30 06:38:38 | 6            | 7                    | 0         | null                | 2019-07-01 00:00:00 | # last_activity_at for 67, 212 comes from this line (the last activity is made by a user)
  ...
  Scenario: Get progress of the second and the third users (checks sorting, from.*, and limit)
    ...
    [
      ...
      },
      {
        ...
        "hints_requested": 1,
        "item_id": "212",
        "last_activity_at": "2019-07-01T00:00:00Z",
        "score": 20,
      ...
      },
      {
        ...
        "hints_requested": 0,
        "item_id": "213",
        "last_activity_at": "2018-11-01T00:00:00Z",
        "score": 0,
        "submissions_attempts": 0,
        "time_spent": 20895545,
        "validated": false
      },
      {
        ...
        "hints_requested": 10,
        "item_id": "214",
        "last_activity_at": "2017-05-30T06:38:48Z",
        "score": 15,
...

      {
        "group_id": "51",
        "item_id": "211",
        "last_activity_at": "2018-05-30T06:38:38Z",
        "score": 50,
        "hints_requested": 3,
  ...
  Scenario: Get progress of the first user for all the visible items (also checks the limit)
    ...
    [
      ...
      },
      {
        ...
        "hints_requested": 0,
        "item_id": "212",
        "last_activity_at": "2019-06-01T00:00:00Z",
        "score": 10,
        "submissions_attempts": 0,
        "time_spent": 18303545,
        "validated": false
