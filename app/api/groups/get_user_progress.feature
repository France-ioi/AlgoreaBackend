Feature: Display the current progress of users on a subset of items (groupUserProgress)
  Background:
    ...
    And the database has the following table 'groups_attempts':
      ...
      | 14      | 211    | 0      | 2017-05-29 06:38:38 | 0      | 2017-05-29 06:38:38 | 100           | 100                   | 0          | 2017-05-30 06:38:38 | 2018-05-30 06:38:38 | # sLastActivityDate for 51, 211 comes from this line (the last activity is made by a team)
      | 14      | 211    | 1      | 2017-05-29 06:38:38 | 40     | 2017-05-29 06:38:38 | 2             | 3                     | 1          | 2017-05-29 06:38:58 | null                | # min(sValidationDate) for 51, 211 comes from this line (from a team)
      | 14      | 211    | 2      | 2017-05-29 06:38:38 | 50     | 2017-05-29 06:38:38 | 3             | 4                     | 1          | 2017-05-31 06:58:38 | null                | # nbHintsCached & nbSubmissionsAttempts for 51, 211 come from this line (the best attempt is made by a team)
      ...
      | 16      | 212    | 0      | 2018-12-01 00:00:00 | 10     | 2017-05-30 06:38:38 | 0             | 0                     | 0          | null                | 2019-06-01 00:00:00 | # sStartDate for 67, 212 & 63, 212 comes from this line (the first attempt is started by a team)
      | 67      | 212    | 0      | 2019-01-01 00:00:00 | 20     | 2017-06-30 06:38:38 | 1             | 2                     | 0          | null                | 2019-06-01 00:00:00 | # nbHintsCached & nbSubmissionsAttempts for 67, 212 come from this line (the best attempt is made by a user)
      | 67      | 212    | 1      | 2019-01-01 00:00:00 | 10     | 2017-05-30 06:38:38 | 6             | 7                     | 0          | null                | 2019-07-01 00:00:00 | # sLastActivityDate for 67, 212 comes from this line (the last activity is made by a user)
      | 67      | 213    | 0      | 2018-11-01 00:00:00 | 0      | null                | 0             | 0                     | 0          | null                | 2018-11-01 00:00:00 | # sStartDate for 67, 213 comes from this line (the first attempt is started by a user)
      | 67      | 214    | 0      | 2017-05-29 06:38:38 | 15     | 2017-05-29 06:38:48 | 10            | 11                    | 1          | 2017-05-29 06:38:48 | 2017-05-30 06:38:48 | # min(sValidationDate) for 67, 214 comes from this line (from a user)
