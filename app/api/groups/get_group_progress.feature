Feature: Display the current progress of a group on a subset of items (groupGroupProgress)
  Background:
    ...
    And the database has the following table 'groups_attempts':
      | group_id | item_id | order | started_at          | score | best_answer_at      | hints_cached | submissions_attempts | validated_at        |
      ...
      | 14       | 211     | 2     | 2017-05-29 06:38:38 | 50    | 2017-05-29 06:38:38 | 3            | 4                    | 2017-05-30 06:38:38 | # hints_cached & submissions_attempts for 14,211 come from this line
