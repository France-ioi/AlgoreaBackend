Feature: Display the current progress of a group on a subset of items (groupGroupProgress)
  Background:
    ...
    And the database has the following table 'groups_attempts':
      | group_id | item_id | order | started_at          | score_computed | best_answer_id | hints_cached | submissions | validated_at        |
      | 14       | 211     | 0     | 2017-05-29 06:38:38 | 0              | 1              | 100          | 100         | null                |
      | 14       | 211     | 1     | 2017-05-29 06:38:38 | 40             | 2              | 2            | 3           | null                |
      | 14       | 211     | 2     | 2017-05-29 06:38:38 | 50             | 2              | 3            | 4           | 2017-05-30 06:38:38 | # hints_cached & submissions for 14,211 come from this line
      | 14       | 211     | 3     | 2017-05-29 06:38:38 | 50             | 4              | 10           | 20          | null                |
