Feature: Display the current progress of a group on a subset of items (groupGroupProgress)
  Background:
    ...
    And the database has the following table 'groups_attempts':
      | idGroup | idItem | iOrder | sStartDate          | iScore | sBestAnswerDate     | nbHintsCached | nbSubmissionsAttempts | bValidated | sValidationDate     |
      ...
      | 14      | 211    | 2      | 2017-05-29 06:38:38 | 50     | 2017-05-29 06:38:38 | 3             | 4                     | 1          | null                | # nbHintsCached & nbSubmissionsAttempts for 14,211 come from this line
