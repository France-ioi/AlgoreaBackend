Feature: Add a parent-child relation between two groups - robustness
  ...
  Scenario: Parent group ID is wrong
    ...
    When I send a POST request to "/groups/abc/add_child/11"
  ...
  Scenario: Child group ID is missing
    Given I am the user with ID "1"
    When I send a POST request to "/groups/13/add_child/abc"
    Then the response code should be 400
  ...
  Scenario: Child group is Root
    Given I am the user with ID "4"
    When I send a POST request to "/groups/13/add_child/15"
    Then the response code should be 403
    And the response error message should contain "Insufficient access rights"
    And the table "groups_groups" should stay unchanged
    And the table "groups_ancestors" should stay unchanged
  ...
  Scenario: Child group is RootSelf
    Given I am the user with ID "4"
    When I send a POST request to "/groups/13/add_child/16"
    Then the response code should be 403
    And the response error message should contain "Insufficient access rights"
    And the table "groups_groups" should stay unchanged
    And the table "groups_ancestors" should stay unchanged
  ...
  Scenario: Child group is RootAdmin
    Given I am the user with ID "4"
    When I send a POST request to "/groups/13/add_child/17"
    Then the response code should be 403
    And the response error message should contain "Insufficient access rights"
    And the table "groups_groups" should stay unchanged
    And the table "groups_ancestors" should stay unchanged
  ...
  Scenario: Parent group is UserSelf
    Given I am the user with ID "4"
    When I send a POST request to "/groups/18/add_child/11"
    Then the response code should be 403
    And the response error message should contain "Insufficient access rights"
    And the table "groups_groups" should stay unchanged
    And the table "groups_ancestors" should stay unchanged
