Feature: Export the current progress of a group on a subset of items as a CSV file (groupGroupProgressCsv)
  ...
  Scenario: Get progress of groups
    ...
    When I send a GET request to "/groups/1/group-progress-csv?parent_item_ids=210,220,310"
    Then the response code should be 200
    And the response header "Content-Type" should be "text/csv"
    And the response header "Content-Disposition" should be "attachment; filename=groups_progress_for_group_1_and_child_items_of_210_220_310.csv"
  ...
  Scenario: No visible child items
    Given I am the user with id "21"
    When I send a GET request to "/groups/1/group-progress-csv?parent_item_ids=1010"
    Then the response code should be 200
    And the response header "Content-Type" should be "text/csv"
    And the response header "Content-Disposition" should be "attachment; filename=groups_progress_for_group_1_and_child_items_of_1010.csv"
    And the response body should be:
    """
  ...
  Scenario: No parent item ids given
    Given I am the user with id "21"
    When I send a GET request to "/groups/1/group-progress-csv?parent_item_ids="
    Then the response code should be 200
    And the response header "Content-Type" should be "text/csv"
    And the response header "Content-Disposition" should be "attachment; filename=groups_progress_for_group_1_and_child_items_of_.csv"
    And the response body should be:
    """
    Group name
  ...
  Scenario: No groups
    Given I am the user with id "21"
    When I send a GET request to "/groups/13/group-progress-csv?parent_item_ids=210,220,310"
    Then the response code should be 200
    And the response header "Content-Type" should be "text/csv"
    And the response header "Content-Disposition" should be "attachment; filename=groups_progress_for_group_13_and_child_items_of_210_220_310.csv"
    And the response body should be:
    """
    Group name;Chapitre 210;1. Item 211;2. Item 212;3. Item 213;4. Item 214;5. Item 215;Chapter 220;1. Item 221;2. Item 222;3. Item 223;4. Item 224;5. Item 225;Chapitre 310;1. Item 311;2. Item 312;3. Item 313;4. Item 314;5. Item 315
