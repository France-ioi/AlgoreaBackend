Feature: Change item access rights for a group
  Background:
    ...
    And the database has the following table 'groups_items':
      | group_id | item_id | full_access_since | cached_full_access_since | partial_access_since | cached_partial_access_since | cached_grayed_access_since | solutions_access_since | cached_solutions_access_since | manager_access | cached_manager_access | access_reason                                  | creator_user_id |
  ...
  Scenario: Create a new groups_items row (manager access)
    ...
    And the table "groups_items" should be:
      | group_id | item_id | full_access_since   | cached_full_access_since | partial_access_since | cached_partial_access_since | cached_grayed_access_since | solutions_access_since | cached_solutions_access_since | cached_manager_access | access_reason                                  | creator_user_id |
  ...
  Scenario: Create a new groups_items row (owner access on the item's ancestor)
    ...
    Then the response should be "updated"
    And the table "groups_items" should be:
      | group_id | item_id | full_access_since   | cached_full_access_since | partial_access_since | cached_partial_access_since | cached_grayed_access_since | solutions_access_since | cached_solutions_access_since | manager_access | cached_manager_access | owner_access | access_reason                                  | creator_user_id |
  ...
  Scenario: Create a new groups_items row (owner access on the item)
    ...
    Then the response should be "updated"
    And the table "groups_items" should be:
      | group_id | item_id | full_access_since   | cached_full_access_since | partial_access_since | cached_partial_access_since | cached_grayed_access_since | solutions_access_since | cached_solutions_access_since | cached_manager_access | owner_access | access_reason                                  | creator_user_id |
  ...
  Scenario: Create a new groups_items row (the group has only partial access on the item's parent)
    Given I am the user with id "1"
    And the database table 'groups_items' has also the following rows:
      | group_id | item_id | owner_access | partial_access_since | cached_partial_access_since | access_reason                                     | creator_user_id |
  ...
  Scenario: Create a new groups_items row (the group has only full access on the item's parent)
    Given I am the user with id "1"
    And the database table 'groups_items' has also the following rows:
      | group_id | item_id | owner_access | full_access_since   | cached_full_access_since | access_reason                                  | creator_user_id |
      | 21       | 102     | 1            | null                | null                     | the admin is an owner of the item              | 2               |
      | 21       | 103     | 0            | null                | null                     | null                                           | 2               |
  ...
  Scenario: Create a new groups_items row (the group has no access to the item's parents, but has partial access to the item itself)
    Given I am the user with id "1"
    And the database table 'groups_items' has also the following rows:
      | group_id | item_id | owner_access | partial_access_since | cached_partial_access_since | cached_grayed_access_since | access_reason                                     | creator_user_id |
  ...
  Scenario: Create a new groups_items row (the group has no access to the item's parents, but has grayed access to the item itself)
    Given I am the user with id "1"
    And the database table 'groups_items' has also the following rows:
      | group_id | item_id | owner_access | cached_grayed_access_since | access_reason                                    | creator_user_id |
