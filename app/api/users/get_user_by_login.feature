Feature: Get user info by login
  Background:
  ...
  Scenario: All field values are not nulls
    ...
    When I send a GET request to "/users/by-login/user"
  ...
  Scenario: All nullable field values are nulls
    ...
    When I send a GET request to "/users/by-login/jane"
    Then the response code should be 200
    And the response body should be, in JSON:
    """
    {
  ...
  Scenario: The current user can watch members of one of user's groups
    Given I am the user with id "4"
    When I send a GET request to "/users/by-login/paul"
    Then the response code should be 200
    And the response body should be, in JSON:
    """
    {
