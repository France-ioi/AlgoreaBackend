Feature: Get additional times for a group of users/teams on a contest (contestListMembersAdditionalTime) - robustness
  ...
  Scenario: Wrong item_id
    ...
    When I send a GET request to "/contests/abc/members-additional-times?group_id=13"
    Then the response code should be 400
    And the response error message should contain "Wrong value for item_id (should be int64)"

  Scenario: No such item
    Given I am the user with ID "1"
    When I send a GET request to "/contests/90/members-additional-times?group_id=13"
    Then the response code should be 403
    And the response error message should contain "Insufficient access rights"

  Scenario: No access to the item
    Given I am the user with ID "1"
    When I send a GET request to "/contests/10/members-additional-times?group_id=13"
    Then the response code should be 403
    And the response error message should contain "Insufficient access rights"

  Scenario: The item is not a timed contest
    Given I am the user with ID "1"
    When I send a GET request to "/contests/60/members-additional-times?group_id=13"
    Then the response code should be 403
    And the response error message should contain "Insufficient access rights"

  Scenario: The user is not a contest admin
    Given I am the user with ID "1"
    When I send a GET request to "/contests/50/members-additional-times?group_id=13"
    Then the response code should be 403
    And the response error message should contain "Insufficient access rights"

  Scenario: Wrong group_id
    Given I am the user with ID "1"
    When I send a GET request to "/contests/70/members-additional-times?group_id=abc"
    Then the response code should be 400
    And the response error message should contain "Wrong value for group_id (should be int64)"

  Scenario: The group is not owned by the user
    Given I am the user with ID "1"
    When I send a GET request to "/contests/70/members-additional-times?group_id=12"
    Then the response code should be 403
    And the response error message should contain "Insufficient access rights"

  Scenario: No such group
    Given I am the user with ID "1"
    When I send a GET request to "/contests/70/members-additional-times?group_id=404"
    Then the response code should be 403
    And the response error message should contain "Insufficient access rights"

  Scenario: Wrong sort
    Given I am the user with ID "1"
    When I send a GET request to "/contests/70/members-additional-times?group_id=13&sort=title"
    Then the response code should be 400
