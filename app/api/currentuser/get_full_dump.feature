  ...
  Scenario: Full data
    ...
    """
    {
      "current_user": {
        ...
        "creator_user_group_id": null, "grade": 1, "graduation_year": 0, "member_state": 0, "step_level_in_site": 0,
      ...
      "groups_attempts": [
        {
          ...
          "group_id": "11", "item_id": "404", "creator_user_group_id": null, "children_validated": 0,
        ...
        },
        {
          ...
          "order": 0, "precision": 0, "score": 0, "score_computed": 0, "score_diff_manual": 0, "score_reeval": 0,
          "group_id": "2", "item_id": "404", "creator_user_group_id": null, "children_validated": 0,
          "corrections_read": 0, "hints_cached": 0, "submissions_attempts": 0, "tasks_solved": 0, "tasks_tried": 0,
          "tasks_with_help": 0, "all_lang_prog": null, "ancestors_computation_state": "done",
          "best_answer_at": null, "entered_at": null, "finished_at": null, "hints_requested": null,
          "latest_activity_at": null, "latest_answer_at": null, "latest_hint_at": null, "score_diff_comment": "",
      ...
      "groups_groups": [
        {
          "id": "2", "child_order": 0, "child_group_id": "11", "parent_group_id": "1", "inviting_user_group_id": null,
          "name": "Our Class", "role": "member", "type_changed_at": "2019-07-09T21:02:28Z", "type": "invitationSent",
          "expires_at": "9999-12-31T23:59:59Z"
        },
        {
          "id": "3", "child_order": 0, "child_group_id": "11", "parent_group_id": "2", "inviting_user_group_id": "11",
          "name": "Our Team", "role": "member", "type_changed_at": "2019-07-09T22:02:28Z", "type": "invitationAccepted",
          "expires_at": "9999-12-31T23:59:59Z"
        },
        {
          "id": "4", "child_order": 0, "child_group_id": "11", "parent_group_id": "3", "inviting_user_group_id": "11",
          "name": "Our Club", "role": "member", "type_changed_at": "2019-07-09T23:02:28Z", "type": "requestSent",
          "expires_at": "9999-12-31T23:59:59Z"
        },
        {
          "id": "5", "child_order": 0, "child_group_id": "11", "parent_group_id": "4", "inviting_user_group_id": "21",
          "name": "Our Friends", "role": "member", "type_changed_at": "2019-07-10T00:02:28Z", "type": "requestRefused",
          "expires_at": "9999-12-31T23:59:59Z"
        },
        {
          "id": "6", "child_order": 0, "child_group_id": "11", "parent_group_id": "5", "inviting_user_group_id": "21",
          "name": "Other people", "role": "member", "type_changed_at": "2019-07-10T01:02:28Z", "type": "invitationAccepted",
          "expires_at": "9999-12-31T23:59:59Z"
        },
        {
          "id": "7", "child_order": 0, "child_group_id": "11", "parent_group_id": "6", "inviting_user_group_id": "21",
          "name": "Another Class", "role": "member", "type_changed_at": "2019-07-10T02:02:28Z", "type": "requestAccepted",
          "expires_at": "9999-12-31T23:59:59Z"
        },
        {
          "id": "8", "child_order": 0, "child_group_id": "11", "parent_group_id": "7", "inviting_user_group_id": "11",
          "name": "Another Team", "role": "member", "type_changed_at": "2019-07-10T03:02:28Z", "type": "removed",
          "expires_at": "9999-12-31T23:59:59Z"
        },
        {
          "id": "9", "child_order": 0, "child_group_id": "11", "parent_group_id": "8", "inviting_user_group_id": "11",
          "name": "Another Club", "role": "member", "type_changed_at": "2019-07-10T04:02:28Z", "type": "left",
          "expires_at": "9999-12-31T23:59:59Z"
        },
        {
          "id": "10", "child_order": 0, "child_group_id": "11", "parent_group_id": "9", "inviting_user_group_id": "21",
          "name": "Some other friends", "role": "member", "type_changed_at": "2019-07-10T05:02:28Z", "type": "direct",
          "expires_at": "9999-12-31T23:59:59Z"
        },
        {
          "id": "14", "child_order": 0, "child_group_id": "11", "parent_group_id": "10", "inviting_user_group_id": null,
      ...
      "refresh_token": {"user_group_id": "11", "refresh_token": "***"},
      "sessions": [
        {
          "user_group_id": "11", "access_token": "***", "expires_at": "2019-07-17T00:02:28Z",
      ...
      "users_answers": [
        {
          ...
          "user_group_id": "11", "answer": null, "graded_at": null, "lang_prog": null,
          "name": null, "state": null, "submitted_at": "2019-07-09T21:02:28Z", "type": "Submission"
        }
      ],
      "users_items": [
        {
          "active_attempt_id": "111", "item_id": "404", "user_group_id": "11"
        }
      ]
    }
    """
  ...
  Scenario: All optional arrays and objects are empty
    ...
    """
    {
      "current_user": {
        ...
        "notify_news": 0, "photo_autoload": 0, "public_first_name": 0, "public_last_name": 0, "creator_user_group_id": null,
      ...
      "sessions": [
        {
          "user_group_id": "31", "access_token": "***", "expires_at": "2019-07-17T00:02:28Z",
          "issued_at": "2019-07-16T22:02:28Z", "issuer": null
        }
      ],
      "users_answers": [],
