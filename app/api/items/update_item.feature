...
Background:
  ...
  And the database has the following table 'items':
    ...
    | 21 | Chapter | http://someurl1.com/ | {"opt":1} | en                   | 1        | Task 1  | 0                 | 1                         | 0        | 1         | forceNo     | List            | 1             | 1           | One             | Half                             | 0                  | 10                  | 1                        | 01:20:30 | 1                       | 1               | 1                            | 2007-01-01 01:02:03 | 3007-01-01 01:02:03 | null                  |
    | 50 | Chapter | http://someurl2.com/ | {"opt":2} | en                   | 1        | Task 2  | 0                 | 1                         | 0        | 1         | forceNo     | List            | 1             | 1           | One             | Half                             | 0                  | 10                  | 1                        | 01:20:30 | 1                       | 1               | 1                            | 2007-01-01 01:02:03 | 3007-01-01 01:02:03 | null                  |
    | 60 | Chapter | http://someurl2.com/ | {"opt":2} | en                   | 1        | Task 3  | 0                 | 1                         | 0        | 1         | forceNo     | List            | 1             | 1           | One             | Half                             | 0                  | 10                  | 1                        | 01:20:30 | 1                       | 1               | 1                            | 2007-01-01 01:02:03 | 3007-01-01 01:02:03 | 1234                  |
  ...
  Scenario: Valid
    ...
    And the table "items" at id "50" should be:
      ...
      | 50 | Chapter | http://someurl3.com/ | {"opt":3} | en                   | 1        | Task 2  | 0                 | 1                         | 0        | 1         | forceNo     | List            | 1             | 1           | One             | Half                             | 0                  | 10                  | 1                        | 01:20:30 | 1               | 1                            | 2007-01-01 01:02:03 | 3007-01-01 01:02:03 | null                  |
  ...
  Scenario: Valid (all the fields are set)
    ...
    And the table "items" at id "50" should be:
      ...
      | 50 | Chapter | http://myurl.com/ | {"opt":true} | sl                   | 1                  | 0        | Task number 1 | 1                 | 0                         | 1        | 0         | forceYes    | Grid            | 0             | 0           | AllButOne       | All                              | 1                  | 2345                | 0                        | 01:02:03 | 1                       | 0               | 0                            | 5577006791947779410   |
    And the table "items_strings" should stay unchanged
