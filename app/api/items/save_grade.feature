Feature: Save grading result
  ...
  Scenario: User is able to save the grading result with a high score and attempt_id
    ...
    And the table "users_items" should be:
      | user_id | item_id | score | tasks_tried | validated | key_obtained | ancestors_computation_state | ABS(TIMESTAMPDIFF(SECOND, last_activity_at, NOW())) < 3 | ABS(TIMESTAMPDIFF(SECOND, last_answer_at, NOW())) < 3 | ABS(TIMESTAMPDIFF(SECOND, best_answer_at, NOW())) < 3 | ABS(TIMESTAMPDIFF(SECOND, validated_at, NOW())) < 3 |
    ...
    And the table "groups_attempts" should be:
      | id  | score | tasks_tried | validated | key_obtained | ancestors_computation_state | ABS(TIMESTAMPDIFF(SECOND, last_activity_at, NOW())) < 3 | ABS(TIMESTAMPDIFF(SECOND, last_answer_at, NOW())) < 3 | ABS(TIMESTAMPDIFF(SECOND, best_answer_at, NOW())) < 3 | ABS(TIMESTAMPDIFF(SECOND, validated_at, NOW())) < 3 |
