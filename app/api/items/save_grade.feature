Feature: Save grading result
  ...
  Scenario: User is able to save the grading result with a high score
  ...
  Scenario: User is able to save the grading result with a low score
    Given I am the user with ID "10"
    And the following token "priorUserTaskToken" signed by the app is distributed:
      """
      {
  ...
  Scenario: User is able to save the grading result with a low score but still obtaining a key
    Given I am the user with ID "10"
    And the following token "priorUserTaskToken" signed by the app is distributed:
      """
      {
