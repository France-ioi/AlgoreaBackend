Feature: Get item view information
  ...
  Background:
    ...
    And the database has the following table 'items':
      | id  | type    | default_language_tag | no_score | display_details_in_parent | validation_type | entry_min_allowed_members | entry_frozen_teams | entry_max_team_size | allows_multiple_attempts | entry_participant_type | duration | prompt_to_join_group_by_code | title_bar_visible | read_only | full_screen | show_user_infos | url            | uses_api | hints_allowed |
