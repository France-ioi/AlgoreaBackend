Feature: Get item dependencies
  ...
  Scenario: Full access on all items (as user)
    ...
    When I send a GET request to "/items/200/dependencies"
  ...
  Scenario: Info access on dependencies (as user)
  ...
  Scenario: Info access on dependencies (as team)
    Given I am the user with id "11"
    When I send a GET request to "/items/200/dependencies?as_team_id=26"
    Then the response code should be 200
    And the response body should be, in JSON:
    """
    [
  ...
  Scenario: Info access on dependencies (as user) with watched_group_id
    Given I am the user with id "22"
    When I send a GET request to "/items/200/dependencies?watched_group_id=15"
    Then the response code should be 200
    And the response body should be, in JSON:
    """
    [
  ...
  Scenario: No visible dependencies (as user)
