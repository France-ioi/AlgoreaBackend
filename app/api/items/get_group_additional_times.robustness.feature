Feature: Get additional times for a group on an item with duration (itemGetAdditionalTime) - robustness
  ...
  Scenario: Wrong item_id
    ...
    When I send a GET request to "/items/abc/groups/13/additional-times"
    Then the response code should be 400
    And the response error message should contain "Wrong value for item_id (should be int64)"

  Scenario: No such item
    Given I am the user with id "21"
    When I send a GET request to "/items/90/groups/13/additional-times"
    Then the response code should be 403
    And the response error message should contain "Insufficient access rights"

  Scenario: No access to the item
    Given I am the user with id "21"
    When I send a GET request to "/items/10/groups/13/additional-times"
    Then the response code should be 403
    And the response error message should contain "Insufficient access rights"

  Scenario: The item doesn't have a duration
    Given I am the user with id "21"
    When I send a GET request to "/items/60/groups/13/additional-times"
    Then the response code should be 403
    And the response error message should contain "Insufficient access rights"
  ...
  Scenario: Wrong group_id
    Given I am the user with id "21"
    When I send a GET request to "/items/70/groups/abc/additional-times"
    Then the response code should be 400
    And the response error message should contain "Wrong value for group_id (should be int64)"

  Scenario: The user is not a manager of the group
    Given I am the user with id "21"
    When I send a GET request to "/items/70/groups/12/additional-times"
    Then the response code should be 403
    And the response error message should contain "Insufficient access rights"

  Scenario: The user cannot watch for members of the group
    Given I am the user with id "21"
    When I send a GET request to "/items/70/groups/14/additional-times"
    Then the response code should be 403
    And the response error message should contain "Insufficient access rights"

  Scenario: The user cannot grant access to the group
    Given I am the user with id "21"
    When I send a GET request to "/items/70/groups/15/additional-times"
    Then the response code should be 403
    And the response error message should contain "Insufficient access rights"

  Scenario: No such group
    Given I am the user with id "21"
    When I send a GET request to "/items/70/groups/404/additional-times"
    Then the response code should be 403
    And the response error message should contain "Insufficient access rights"
