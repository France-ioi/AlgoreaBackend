Feature: Get activity log for a thread - access
  ...
  Scenario Outline: User has can_view>=content on the item and participant_id = authenticated user's self group
    Given I am @User
  ...
  Scenario: User has can_view>=content on the item (via an ancestor group) and participant_id = authenticated user's self group
    Given I am @User
  ...
  Scenario: User has can_view>=content on the item and the user is a team member of participant_id
    Given I am @User
  ...
  Scenario: One of the user's teams has can_view>=content on the item and the user is a team member of participant_id
    Given I am @User
  ...
  Scenario: One of the user's teams has can_view>=content (via an ancestor) on the item and the user is a team member of participant_id
    Given I am @User
    And there is a team @Team1
    And there is a team @Team2
    And I am a member of the group @Team1
  ...
  Scenario: User can view content and has can_watch>=answer on item_id
    Given I am @User
    And I can view content of the item @Item2
  ...
  Scenario Outline: User can view content and has can_watch>=answer (via an ancestor) on item_id
    Given I am @User
