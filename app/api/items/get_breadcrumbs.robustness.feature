Feature: Get item information for breadcrumb - robustness
  ...
  Scenario: Should fail when breadcrumb hierarchy is corrupt (one parent-child link missing at the end), but user has full access to all
    Given the database has the following table 'groups_items':
      ...
      | 42 | 13       | 22      | 2017-05-29 06:38:38      | 2037-05-29 06:38:38         | 2037-05-29 06:38:38        | 0               |
      | 43 | 13       | 23      | 2017-05-29 06:38:38      | 2037-05-29 06:38:38         | 2037-05-29 06:38:38        | 0               |
      | 44 | 13       | 24      | 2017-05-29 06:38:38      | 2037-05-29 06:38:38         | 2037-05-29 06:38:38        | 0               |
    And the database has the following table 'items_items':
      | id | parent_item_id | child_item_id | child_order | difficulty |
      | 52 | 21             | 22            | 1           | 0          |
      | 53 | 22             | 23            | 1           | 0          |
  ...
  Scenario: Should fail when the first item of hierarchy is not a root item, and user has full access to all
    Given the database has the following table 'groups_items':
      | id | group_id | item_id | cached_full_access_since | cached_partial_access_since | cached_grayed_access_since | creator_user_id |
      | 42 | 13       | 22      | 2017-05-29 06:38:38      | 2037-05-29 06:38:38         | 2037-05-29 06:38:38        | 0               |
      | 44 | 13       | 23      | 2017-05-29 06:38:38      | 2037-05-29 06:38:38         | 2037-05-29 06:38:38        | 0               |
    And the database has the following table 'items_items':
      | id | parent_item_id | child_item_id | child_order | difficulty |
      | 52 | 22             | 23            | 1           | 0          |
      | 53 | 23             | 24            | 1           | 0          |
  ...
  Scenario: Should fail when the user has greyed access to middle element, partial access to the rest
    Given the database has the following table 'groups_items':
      ...
      | 42 | 13       | 22      | 2037-05-29 06:38:38      | 2037-05-29 06:38:38         | 2017-05-29 06:38:38        | 0               |
