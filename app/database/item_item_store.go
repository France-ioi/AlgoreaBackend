...
func (s *ItemItemStore) ContentViewPropagationNameByIndex(index int) string {
	getterFunc := func() string { return requireDBEnumNameByIndex("items_items.content_view_propagation", index) }
...
func (s *ItemItemStore) ContentViewPropagationIndexByName(name string) int {
	getterFunc := func() int { return requireDBEnumIndexByName("items_items.content_view_propagation", name) }
	return getFromEnumUnderLock(s.DB, getterFunc)
}
...
func (s *ItemItemStore) UpperViewLevelsPropagationIndexByName(name string) int {
	getterFunc := func() int { return requireDBEnumIndexByName("items_items.upper_view_levels_propagation", name) }
	return getFromEnumUnderLock(s.DB, getterFunc)
}
