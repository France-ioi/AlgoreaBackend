...
func TestDTValid(t *testing.T) {
	...
	jsonInput := `{ "CreatedAt": "2001-02-03T05:06:07.89Z", "ValidFrom": "2002-01-01T23:11:11.000000001+02:00", ` +
		`"ModifiedAt": "2001-09-02T12:30:00Z", "AccessUntil": "2042-12-31T23:59:59Z" }`
	input := &SampleDTInput{}
...
func TestDTWithNonDT(t *testing.T) {
	...
	jsonInput := `{ "CreatedAt": "2001", "ValidFrom": "2002-01-01T23:11:11Z", "ModifiedAt": "2001-09-02T12:30Z", ` +
		`"AccessUntil": "2042-12-31T23:59:59Z" }`
	input := &SampleDTInput{}
