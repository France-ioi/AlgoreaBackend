...
func TaskPayloadFromAlgoreaPlatform() map[string]interface{} {
...
func TaskPayloadFromAlgoreaPlatformOriginal() map[string]interface{} {
	return map[string]interface{}{
		"idItemLocal":         "901756573345831409",
		"bHintPossible":       true,
		"randomSeed":          "556371821693219925",
...
func AnswerPayloadFromAlgoreaPlatform() map[string]interface{} {
	return map[string]interface{}{
...
func AnswerPayloadFromAlgoreaPlatformOriginal() map[string]interface{} {
	return map[string]interface{}{
		"sAnswer": "{\"idSubmission\":\"899146309203855074\",\"langProg\":\"python\"," +
			"\"sourceCode\":\"print(min(int(input()), int(input()), int(input())))\"}",
		"idUser":          "556371821693219925",
...
// ThreadPayloadFromAlgoreaBackend is a thread token payload generated by a real AlgoreaBackend instance.
func ThreadPayloadFromAlgoreaBackend() map[string]interface{} {
	return map[string]interface{}{
		"item_id":        "1",
		"participant_id": "2",
		"user_id":        "3",
		...
		"can_watch":      true,
		"can_write":      false,
		"exp":            float64(1577844000), //nolint:mnd // 01-01-2020 00:02:00 UTC
		"date":           "01-01-2020",
	}
}

// HintPayloadFromTaskPlatform is a hint token payload generated by a real TaskPlatform instance.
func HintPayloadFromTaskPlatform() map[string]interface{} {
	return map[string]interface{}{
...
func ScorePayloadFromGrader() map[string]interface{} {
	return map[string]interface{}{
		"idUser":       "556371821693219925",
