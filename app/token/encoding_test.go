...
const (
	...
	answerTokenFromAlgoreaPlatform = "" +
	...
	threadTokenFromAlgoreaPlatform = "" +
...
func TestParseAndValidate(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			token:       []byte(taskTokenFromAlgoreaPlatform),
		...
		},
		{
			...
			currentTime: time.Date(2019, 5, 2, 12, 0, 0, 0, time.UTC),
			token:       []byte(answerTokenFromAlgoreaPlatform),
		...
		},
		{
			...
			token:       []byte(threadTokenFromAlgoreaPlatform),
