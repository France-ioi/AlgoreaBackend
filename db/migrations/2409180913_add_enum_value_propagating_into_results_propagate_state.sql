...
-- +migrate Down
ALTER TABLE `results_propagate` MODIFY `state` ENUM('to_be_propagated','to_be_recomputed') NOT NULL COMMENT '"to_be_propagated" means that ancestors should be recomputed';
