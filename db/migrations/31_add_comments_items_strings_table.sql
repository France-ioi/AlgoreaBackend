...
ALTER TABLE `items_strings`
  ...
  MODIFY COLUMN `sTitle` varchar(200) NOT NULL DEFAULT '' COMMENT 'Title of the item, in the specified language',
  MODIFY COLUMN `sImageUrl` varchar(100) DEFAULT NULL COMMENT 'Url of a small image associated with this item.',
...
ALTER TABLE `items_strings`
  ...
  MODIFY COLUMN `sTitle` varchar(200) NOT NULL DEFAULT '' COMMENT '',
  MODIFY COLUMN `sImageUrl` varchar(100) DEFAULT NULL COMMENT '',
