...
INSERT INTO `groups_items` (`group_id`, `item_id`, `additional_time`,`creator_user_id`)
    SELECT group_id, groups_contest_items.item_id, groups_contest_items.additional_time, 0
