...
ALTER TABLE `groups`
  ...
  MODIFY COLUMN `sCodeTimer` time DEFAULT NULL COMMENT 'How long after the first use of the code it will expire',
  MODIFY COLUMN `sCodeEnd` datetime DEFAULT NULL COMMENT 'When the code expires. Set when it is first used.',
